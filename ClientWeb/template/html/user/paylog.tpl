...
<body>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/User/PayLog">
    ...
    <script>
        ...
        var pagenum = 1;
        $(function(){
            tGet("/User/GetPayOrderPageMax", function (rt) {
                var r = JSON.parse(rt);
                if (r.count ) {
                    pagenum = r.count;
        ...
        function GetPayOrder() {
            ...
            tGet("/User/GetPayOrder?pageindex" + pageindex, function (rt) {
                var r = JSON.parse(rt);
                if (r.list && r.list != null) {
                    ...
                    for (var i = 0; i < lst.length; i++) {
                        var r = lst[i];
                        html += '<tr><th>' + r.Id + '</th><th>' + r.Money + '</th<th>' + r.ProName + '</th><th>' + r.PayWay + '</th><th>' + r.FinishTime +'</th></tr >';
                    }
                    $("#paylist").html(html);
                }
            }); 
