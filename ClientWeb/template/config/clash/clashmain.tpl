...
proxies:
{serverinfo}proxy-groups:
  - name: {SystemName}
    type: select
    proxies:
{allserver}  - name: 🍎 Apple
    type: select
    proxies:
      - DIRECT
      - {SystemName}
  - name: 🎬 Emby
    type: select
    proxies:
{allserver_emby}      - {SystemName}
      - DIRECT
{allserver}  - name: 📲 Telegram
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 🎬 YouTube
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 🎬 Bilibili
    type: select
    proxies:
      - DIRECT
      - {SystemName}
{allserver}  - name: 🎬 myTVSUPER
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 📲 LineTV
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 🎬 iQiyi
    type: select
    proxies:
      - DIRECT
      - {SystemName}
{allserver}  - name: 🎵 Tiktok
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 📺 Netflix
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 🌐 Google
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 🖥 Microsoft
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 📟 Twitter
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: 📺 International-Media
    type: select
    proxies:
      - {SystemName}
      - DIRECT
{allserver}  - name: China-Media
    type: select
    proxies:
      - DIRECT
      - {SystemName}
...
rules:
  ...
  - DOMAIN-SUFFIX,steampowered.com,China-Websites
  - DOMAIN-SUFFIX,steam-chat.com,China-Websites
  - DOMAIN-SUFFIX,steamgames.com,China-Websites
  - DOMAIN-SUFFIX,steamusercontent.com,China-Websites
  - DOMAIN-SUFFIX,steamcontent.com,China-Websites
  - DOMAIN-SUFFIX,steamstatic.com,China-Websites
  - DOMAIN-SUFFIX,steamcdn-a.akamaihd.net,China-Websites
